...
public abstract class Tree {
    ...
    public static class TLambda extends TypeLit {
        public TypeLit returnType;
        public List<TypeLit> paramType;

        public TLambda(TypeLit returnType, List<TypeLit> paramType, Pos pos) {
    ...
    public static class Lambda extends Expr {
        ...
        public boolean isBlock() {
            if(block.isPresent())
                ...
                throw new RuntimeException("Invalid Lambda. Expect Block or Expr");
        }
        ...
        public Object treeElementAt(int index) {
            return switch (index) {
                case 0 -> params;
                case 1 -> isBlock() ? block.get() : expr.get();
                default -> throw new IndexOutOfBoundsException(index);
            };
        }
    ...
    public static class Modifiers {
        ...
        public boolean isAbstract() { return code == ABSTRACT; }
